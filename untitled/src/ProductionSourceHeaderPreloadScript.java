print('INFO - Current And Last Successful Load Dates Start ===========================================================================');
        ...
        # Special Procurement type 1
        if ($G_SPECIAL_PROC_TYPE_1 is null or $G_SPECIAL_PROC_TYPE_1 = '40')
        print('INFO - Special Procurement Type 1 variable $G_SPECIAL_PROC_TYPE_1 with default value: '|| $G_SPECIAL_PROC_TYPE_1);
        else
        begin
        print('INFO -  Special Procurement Type 1 variable $G_SPECIAL_PROC_TYPE_1 set by input to: '|| $G_SPECIAL_PROC_TYPE_1);
        $G_STANDARD_LOAD = 'no';
        end

        # Special Procurement type 2
        if ($G_SPECIAL_PROC_TYPE_2 is null or $G_SPECIAL_PROC_TYPE_2 = '41')
        print('INFO - Special Procurement Type 2 variable $G_SPECIAL_PROC_TYPE_2 with default value: '|| $G_SPECIAL_PROC_TYPE_2);
        else
        begin
        print('INFO -  Special Procurement Type 2 variable $G_SPECIAL_PROC_TYPE_2 set by input to: '|| $G_SPECIAL_PROC_TYPE_2);
        $G_STANDARD_LOAD = 'no';
        end

        # Special Procurement type 3
        if ($G_SPECIAL_PROC_TYPE_3 is null or $G_SPECIAL_PROC_TYPE_3 = '42')
        print('INFO - Special Procurement Type 3 variable $G_SPECIAL_PROC_TYPE_3 with default value: '|| $G_SPECIAL_PROC_TYPE_3);
        else
        begin
        print('INFO -  Special Procurement Type 3 variable $G_SPECIAL_PROC_TYPE_3 set by input to: '|| $G_SPECIAL_PROC_TYPE_3);
        $G_STANDARD_LOAD = 'no';
        end

        # Special Procurement type 4
        if ($G_SPECIAL_PROC_TYPE_4 is null or $G_SPECIAL_PROC_TYPE_4 = '43')
        print('INFO - Special Procurement Type 4 variable $G_SPECIAL_PROC_TYPE_4 with default value: '|| $G_SPECIAL_PROC_TYPE_4);
        else
        begin
        print('INFO -  Special Procurement Type 4 variable $G_SPECIAL_PROC_TYPE_4 set by input to: '|| $G_SPECIAL_PROC_TYPE_4);
        $G_STANDARD_LOAD = 'no';
        end

        # Special Procurement type 5
        if ($G_SPECIAL_PROC_TYPE_5 is null or $G_SPECIAL_PROC_TYPE_5 = '44')
        print('INFO - Special Procurement Type 5 variable $G_SPECIAL_PROC_TYPE_5 with default value: '|| $G_SPECIAL_PROC_TYPE_5);
        else
        begin
        print('INFO -  Special Procurement Type 5 variable $G_SPECIAL_PROC_TYPE_5 set by input to: '|| $G_SPECIAL_PROC_TYPE_5);
        $G_STANDARD_LOAD = 'no';
        end

        # MRP TYPE 1
        if ($G_MRP_TYPE_1 is null or $G_MRP_TYPE_1 = 'X0')
        print('INFO - MRP Type 1 variable $G_MRP_TYPE_1 with default value: '|| $G_MRP_TYPE_1);
        else
        begin
        print('INFO -  MRP Type 1 area variable $G_MRP_TYPE_1 set by input to: '|| $G_MRP_TYPE_1);
        $G_STANDARD_LOAD = 'no';
        end
