print('INFO - Current And Last Successful Load Dates Start ===========================================================================');
        ...
        if ($G_PAST_DAYS is not null and $G_PAST_DAYS <> 30)
        begin
        print('INFO - variable $G_PAST_DAYS set by input to: '|| $G_PAST_DAYS);
        $G_STANDARD_LOAD = 'no';
        end
        else
        print('INFO - variable $G_PAST_DAYS with default value: '|| $G_PAST_DAYS);
