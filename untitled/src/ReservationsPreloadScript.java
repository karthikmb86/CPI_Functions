print('INFO - Current And Last Successful Load Dates Start ===========================================================================');
        ...
        # Future Weeks
        if ($G_FUTURE_WEEKS is null or $G_FUTURE_WEEKS = '52')
        print('INFO - Future weeks variable $G_FUTURE_WEEKS with default value: '|| $G_FUTURE_WEEKS);
        else
        begin
        print('INFO -  Future weeks variable $G_FUTURE_WEEKS set by input to: '|| $G_FUTURE_WEEKS);
        end

        # Past Weeks
        if ($G_PAST_WEEKS is null or $G_PAST_WEEKS = '4')
        print('INFO - Past weeks variable $G_PAST_WEEKS with default value: '|| $G_PAST_WEEKS);
        else
        begin
        print('INFO -  Past weeks variable $G_PAST_WEEKS set by input to: '|| $G_PAST_WEEKS);
        end
