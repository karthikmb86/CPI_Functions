print('INFO - Current And Last Successful Load Dates Start ===========================================================================');
        ...
        # Exchange Rate Type
        if ($G_EXCHANGE_RATE_TYPE is NULL) print('INFO - Exchange Rate type $G_EXCHANGE_RATE_TYPE with default value: NULL ');
        else
        begin
        print('INFO -  Exchange Rate type $G_EXCHANGE_RATE_TYPE set by input to: '|| $G_EXCHANGE_RATE_TYPE);
        $G_STANDARD_LOAD = 'no';
        end
