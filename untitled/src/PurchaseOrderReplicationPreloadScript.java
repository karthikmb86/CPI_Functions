print('INFO - Current And Last Successful Load Dates Start ===========================================================================');
        ...
        if ($G_MRP_ELEMENT is not null and $G_MRP_ELEMENT <> 'BE')
        begin
        print('INFO - variable $G_MRP_ELEMENT set by input to: '|| $G_MRP_ELEMENT);
        end
        else
        print('INFO - variable $G_MRP_ELEMENT with default value: '|| $G_MRP_ELEMENT);
